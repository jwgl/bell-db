...
select booking_form.id,
  ...
  (select jsonb_agg(jsonb_build_object(
      ...
      'facilities', (select jsonb_agg(jsonb_build_object(
          ...
          'basePrice', booking_facility.base_price,
