...
Insert into TERM (ID,START_DATE,START_WEEK,MID_LEFT,MID_RIGHT,END_WEEK,MAX_WEEK) values (20142,to_date('2015-03-02','yyyy-mm-dd'),1,19,20,21,28);
Insert into TERM (ID,START_DATE,START_WEEK,MID_LEFT,MID_RIGHT,END_WEEK,MAX_WEEK) values (20151,to_date('2015-09-14','yyyy-mm-dd'),1,null,null,19,24);
...
Insert into TERM (ID,START_DATE,START_WEEK,MID_LEFT,MID_RIGHT,END_WEEK,MAX_WEEK) values (20161,to_date('2016-09-05','yyyy-mm-dd'),1,null,null,19,24);
Insert into TERM (ID,START_DATE,START_WEEK,MID_LEFT,MID_RIGHT,END_WEEK,MAX_WEEK) values (20162,to_date('2017-02-20','yyyy-mm-dd'),1,19,20,21,28);
