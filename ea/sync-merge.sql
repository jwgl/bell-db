...
insert into ea.et_course_class_map(original_id)
select original_id
...
-- 任务ID转换
insert into ea.et_task_map(original_id, course_item_id)
select original_id, course_item_id
...
where original_id like '(2015-2016-1)%'
